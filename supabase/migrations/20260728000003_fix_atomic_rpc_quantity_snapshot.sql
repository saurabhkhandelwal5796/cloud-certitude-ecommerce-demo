-- ============================================================
-- Migration: Fix Atomic RPC Quantity Extraction for Snapshots
-- Date: 2026-07-28
-- Description: Updates checkout_order_atomic and restore_inventory_atomic
-- to extract quantity via COALESCE(item->'pricing'->>'quantity', item->>'quantity')
-- supporting both modern OrderItemSnapshot structure and legacy items, with
-- strict invalid quantity validations.
-- ============================================================

-- ─── 1. Update checkout_order_atomic ──────────────────────────────────────────
...
-- ─── 2. Update restore_inventory_atomic ───────────────────────────────────────
