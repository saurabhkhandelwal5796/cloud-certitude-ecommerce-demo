    ...
    <div className="bg-slate-950 text-white min-h-screen">
      ...
      <section className="relative h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-950">
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover opacity-45 scale-105 select-none"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-slate-950/40 via-slate-950/20 to-slate-950" />

        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
          <span className="text-[10px] sm:text-xs md:text-sm font-extrabold uppercase tracking-[0.3em] text-emerald-400 animate-pulse">
            Introducing Autumn/Winter &apos;26
          </span>
          <h1 className="mt-4 text-4xl font-extrabold tracking-widest text-white uppercase sm:text-6xl md:text-7xl lg:text-8xl">
            LUXURY REDEFINED
          </h1>
          <p className="mt-6 text-sm sm:text-base md:text-lg text-slate-300 font-light max-w-2xl mx-auto leading-relaxed">
            Discover timeless fashion curated for every occasion. Exquisite tailoring, sustainably made, made to last.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="#men"
              className="w-full sm:w-auto rounded-full bg-emerald-500 px-8 py-3.5 text-xs font-bold uppercase tracking-wider text-slate-950 hover:bg-emerald-400 transition-colors shadow-lg hover:shadow-emerald-500/20"
            >
              Shop Men
            </Link>
            <Link
              href="#women"
              className="w-full sm:w-auto rounded-full border border-white/20 bg-white/5 px-8 py-3.5 text-xs font-bold uppercase tracking-wider text-white hover:bg-white/10 hover:border-white transition-colors backdrop-blur-sm"
            >
              Shop Women
            </Link>
          </div>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-slate-500 text-[10px] uppercase tracking-widest">
          Scroll Down
          <svg className="h-4 w-4 animate-bounce text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center md:text-left mb-12">
          <h2 className="text-2xl font-bold tracking-widest text-white uppercase sm:text-3xl">
            Curated Collections
          </h2>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6 text-left">
              ...
              <h2 className="text-2xl font-bold tracking-wider uppercase text-white sm:text-4xl">
              ...
              <div className="flex gap-8 border-t border-white/5 pt-6">
                <div>
                  ...
                  <p className="text-[10px] uppercase text-slate-500 mt-1 font-bold">Organic Cotton</p>
                </div>
                <div>
                  <h4 className="text-xl font-bold text-white">Zero</h4>
                  <p className="text-[10px] uppercase text-slate-500 mt-1 font-bold">Toxic Dyes Used</p>
                </div>
                <div>
                  <h4 className="text-xl font-bold text-white">Fair</h4>
                  <p className="text-[10px] uppercase text-slate-500 mt-1 font-bold">Wages Guaranteed</p>
                </div>
              </div>
            </div>
            <div className="relative aspect-[16/10] rounded-2xl overflow-hidden bg-slate-950 border border-white/5">
              <Image
      ...
      <section id="featured" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-2 text-sm text-slate-400 font-light max-w-lg mx-auto">
      ...
      <section id="new-arrivals" className="bg-slate-900/20 border-t border-white/5 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-12">
            ...
            {/* Horizontal scroll indicator (desktop only) */}
            <div className="hidden sm:flex gap-1.5 text-xs text-slate-500 items-center mt-4 sm:mt-0 uppercase tracking-widest font-bold">
              Swipe to explore
              <svg className="h-4 w-4 text-emerald-400 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </div>
          </div>

          {/* Horizontal Scrolling wrapper for mobile & tablet, grid on large */}
          <div className="flex gap-6 overflow-x-auto pb-6 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent -mx-4 px-4 sm:mx-0 sm:px-0">
      ...
      <section className="relative overflow-hidden border-t border-white/5 bg-slate-900/10 py-24">
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-500 via-transparent to-transparent pointer-events-none" />

        <div className="relative z-10 mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-3xl font-extrabold tracking-widest text-white uppercase sm:text-4xl">
            Stay in Style
          </h2>
          <p className="mt-4 text-sm text-slate-400 font-light max-w-md mx-auto leading-relaxed">
          ...
          <div className="mt-10 max-w-md mx-auto">
            {newsletterSubscribed ? (
              <div className="rounded-full bg-emerald-500/10 border border-emerald-500/20 px-6 py-4 text-sm text-emerald-400 font-semibold leading-relaxed">
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="w-full rounded-full border border-white/10 bg-white/5 px-5 py-3 text-sm text-white placeholder-slate-500 shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 disabled:opacity-50"
                />
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full sm:w-auto flex-shrink-0 rounded-full bg-white px-8 py-3 text-xs font-bold uppercase tracking-wider text-slate-950 hover:bg-emerald-400 hover:text-slate-950 disabled:opacity-50 transition-colors cursor-pointer"
                >
